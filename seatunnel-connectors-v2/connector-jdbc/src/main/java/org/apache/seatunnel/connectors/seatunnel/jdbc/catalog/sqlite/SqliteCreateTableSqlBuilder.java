...
public class SqliteCreateTableSqlBuilder extends AbstractJdbcCreateTableSqlBuilder {
    ...
    public SqliteCreateTableSqlBuilder(CatalogTable catalogTable) {
                        ...
                        .map(
                                columns ->
                                        buildColumnCommentSql(
                                                columns, "`" + tablePath.getTableName() + "`"))
                        .collect(Collectors.toList());
