...
public class OpenGaussDataTypeConvertor implements DataTypeConvertor<String> {
    ...
    public SeaTunnelDataType<?> toSeaTunnelType(
        ...
        checkNotNull(connectorDataType, "OpenGauss Type cannot be null");
        switch (connectorDataType) {
            ...
            default:
                throw new UnsupportedOperationException(
                        String.format(
                                "Doesn't support OpenGauss type '%s''  yet.", connectorDataType));
        }
    }
