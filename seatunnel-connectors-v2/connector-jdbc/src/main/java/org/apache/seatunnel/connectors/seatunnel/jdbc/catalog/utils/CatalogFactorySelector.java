...
import org.apache.seatunnel.connectors.seatunnel.jdbc.catalog.redshift.RedshiftCatalogFactory;
...
public class CatalogFactorySelector {
    ...
    public static Optional<CatalogFactory> select(String jdbcURL) {
        ...
        if (jdbcURL.startsWith(PROTOCOL_INFORMIX)) {
            return Optional.of(new InformixCatalogFactory());
        }
        if (jdbcURL.startsWith(PROTOCOL_REDSHIFT)) {
            return Optional.of(new RedshiftCatalogFactory());
        }
