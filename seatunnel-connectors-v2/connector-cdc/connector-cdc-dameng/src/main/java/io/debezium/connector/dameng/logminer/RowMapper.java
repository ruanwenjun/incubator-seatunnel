...
/**
 * A utility class to map LogMiner content resultSet values. This class gracefully logs errors,
 * loosing an entry is not critical. The loss will be logged
 */
public class RowMapper {
    ...
    public static final int LOB_TRIM = 11;
    public static final int SELECT_FOR_UPDATE = 25;
    public static final int LOB_ERASE = 28;
    public static final int MISSING_SCN = 34;
    public static final int ROLLBACK = 36;
    public static final int SEQ_MODIFY = 37;
    public static final int XA_COMMIT = 38;
    ...
    /**
     * It constructs REDO_SQL. If REDO_SQL is in a few lines, it truncates after first 40_000
     * characters It also records LogMiner history info if isDml is true
     *
     * @param rs result set
     ...
     */
    public static String getSqlRedo(
            ResultSet rs,
            boolean isDml,
        ...
        if (isDml) {
            historyRecorder.record(
                    scn, tableName, segOwner, operationCode, changeTime, txId, csf, redoSql);
        }
