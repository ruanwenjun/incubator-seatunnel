...
public class Oracle9BridgeOffsetContext implements OffsetContext {
    ...
    public Oracle9BridgeOffsetContext(
    ...
    public static class Loader implements OffsetContext.Loader<Oracle9BridgeOffsetContext> {
        private final Oracle9BridgeConnectorConfig connectorConfig;

        @Override
        public Map<String, ?> getPartition() {
            return Collections.singletonMap(
                    Oracle9BridgeOffsetContext.SERVER_PARTITION_KEY,
                    connectorConfig.getLogicalName());
        }

        @Override
        public Oracle9BridgeOffsetContext load(Map<String, ?> offset) {
            ...
            return new Oracle9BridgeOffsetContext(
                    connectorConfig,
                    fzsFileNumber,
                    scn,
                    snapshot,
