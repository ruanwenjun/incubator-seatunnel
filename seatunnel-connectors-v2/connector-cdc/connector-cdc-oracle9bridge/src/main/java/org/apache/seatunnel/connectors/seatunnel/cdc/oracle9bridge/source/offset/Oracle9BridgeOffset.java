...
public class Oracle9BridgeOffset extends Offset {
    ...
    public static final Oracle9BridgeOffset INITIAL_OFFSET = new Oracle9BridgeOffset(0, 0L);
    public static final Oracle9BridgeOffset NO_STOPPING_OFFSET =
            new Oracle9BridgeOffset(Integer.MAX_VALUE, Long.MAX_VALUE);

    public Oracle9BridgeOffset(Map<String, String> offset) {
        this.offset = offset;
    }

    public Oracle9BridgeOffset(Integer fzsFileNumber, Long scn) {
    ...
    public int compareTo(Offset offset) {
        Oracle9BridgeOffset that = (Oracle9BridgeOffset) offset;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Oracle9BridgeOffset)) {
            return false;
        }
        Oracle9BridgeOffset that = (Oracle9BridgeOffset) o;
