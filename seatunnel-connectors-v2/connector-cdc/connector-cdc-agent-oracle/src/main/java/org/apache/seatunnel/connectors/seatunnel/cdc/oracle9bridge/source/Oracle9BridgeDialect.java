...
import org.apache.seatunnel.connectors.seatunnel.cdc.oracle9bridge.source.eumerator.OracleChunkSplitter;
...
import org.apache.seatunnel.connectors.seatunnel.cdc.oracle9bridge.source.reader.fetch.incremental.Oracle9BridgeIncrementalFetchTask;
...
@Slf4j
public class Oracle9BridgeDialect implements JdbcDataSourceDialect {

    private static final long serialVersionUID = 1L;
    private final Oracle9BridgeSourceConfig sourceConfig;
    private transient OracleSchema oracleSchema;

    public Oracle9BridgeDialect(Oracle9BridgeSourceConfig sourceConfig) {
    ...
    public List<TableId> discoverDataCollections(JdbcSourceConfig sourceConfig) {
        ...
        Oracle9BridgeSourceConfig oracleSourceConfig = (Oracle9BridgeSourceConfig) sourceConfig;
    ...
    @Override
    public Oracle9BridgeSourceFetchTaskContext createFetchTaskContext(
        ...
        return new Oracle9BridgeSourceFetchTaskContext(taskSourceConfig, this, engineHistory);
    }

    @Override
    public FetchTask<SourceSplitBase> createFetchTask(SourceSplitBase sourceSplitBase) {
        if (sourceSplitBase.isSnapshotSplit()) {
            return new Oracle9BridgeSnapshotFetchTask(
                    sourceConfig, sourceSplitBase.asSnapshotSplit());
        } else {
            return new Oracle9BridgeIncrementalFetchTask(
