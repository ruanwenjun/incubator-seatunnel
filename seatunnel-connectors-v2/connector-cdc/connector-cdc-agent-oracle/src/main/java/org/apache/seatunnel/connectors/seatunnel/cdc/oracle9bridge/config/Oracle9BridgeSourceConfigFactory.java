...
public class Oracle9BridgeSourceConfigFactory extends JdbcSourceConfigFactory {

    private static final long serialVersionUID = 1L;

    private static final String DATABASE_SERVER_NAME = "oracle9bridge";
    ...
    public Oracle9BridgeSourceConfigFactory(
    ...
    @Override
    public Oracle9BridgeSourceConfig create(int subtask) {
        validateConfig();
        ...
        return new Oracle9BridgeSourceConfig(
                startupConfig,
                stopConfig,
                databaseList,
                tableList,
