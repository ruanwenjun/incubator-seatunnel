...
public class SourceInfo extends BaseSourceInfo {
    ...
    // todo: use constant in Oracle9BridgeOffset?
    public static final String SCN_KEY = "scn";
    public static final String FZS_FILE_NUMBER_KEY = "fzs_file_number";

    // This is needed by debezium
    private Scn commitScn;
    private Scn scn;
    // todo: add db_scn used to judge if snapshot changed?
    // todo: add table and table owner?
    private Integer fzsFileNumber;
