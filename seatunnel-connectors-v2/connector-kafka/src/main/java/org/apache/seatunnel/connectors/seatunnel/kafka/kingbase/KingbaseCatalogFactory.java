...
public class KingbaseCatalogFactory implements CatalogFactory {
    ...
    public Catalog createCatalog(String catalogName, ReadonlyConfig options) {
        ...
        return new KingbaseCatalog(
                "Kingbase",
                options.get(KingbaseCatalogConfig.USER),
                options.get(KingbaseCatalogConfig.PASSWORD),
    ...
    public OptionRule optionRule() {
        return OptionRule.builder()
                .required(KingbaseCatalogConfig.URL)
                .optional(KingbaseCatalogConfig.USER, KingbaseCatalogConfig.PASSWORD)
                .build();
    }
}
