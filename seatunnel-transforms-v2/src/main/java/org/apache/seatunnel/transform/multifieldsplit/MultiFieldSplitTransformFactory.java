...
import static org.apache.seatunnel.transform.multifieldsplit.MultiFieldSplitTransformConfig.SPLIT_OPS;

@AutoService(Factory.class)
public class MultiFieldSplitTransformFactory implements TableTransformFactory {
    @Override
